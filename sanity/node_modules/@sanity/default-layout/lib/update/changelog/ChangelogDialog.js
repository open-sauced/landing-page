...
function ChangelogDialog(props) {
  ...
  var hasChangelog = changelog.filter(c => c === null || c === void 0 ? void 0 : c.changeItems).length > 0;
  return /*#__PURE__*/_react.default.createElement(_ui.Dialog, _extends({
    ...
    space: 5,
    paddingY: 4
  }, changelog === null || changelog === void 0 ? void 0 : changelog.map((log, index) => {
    var changeItems = log.changeItems,
        version = log.version;
    var showDivider = index < changelog.length - 1;

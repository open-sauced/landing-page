...
const OpenSaucedLogo:FC<Props> = ({logo}) => {
    ...
    return (
        <div className="w-full tablet:max-w-sm">
            <div className={`flex h-40 w-full border-2 border-orange-500 bg-white rounded-lg border-2 relative border-gray-100 justify-center items-center ${ isBlackBG ? "bg-black" : "bg-none"} ` }>
            ...
            <div className="flex gap-x-4 pt-20">
                <div className="relative">
                    <div className="bg-orange-500 rounded-md blur-sm absolute -inset-[.01rem]">
                    </div>
                    <a className="relative" href={svgLogo as unknown as string} title="Image title">
                ...
                <div className="relative">
                    ...
                    <a className="relative" href={pngLogo as unknown as string} title="Image title">

  ...
  return (
    ...
    <div className=' border-[2px] border-gray200 rounded-xl p-[15px] ' >
        <div className=' flex items-center gap-2 '>
            ...
            <h6 className='text-gray400 font-bold text-[14px] flex-[3]' ><span className='font-bold text-gray400 '>{twitterName} </span > <a className=' hover:text-gray150 font-normal text-[14px] tracking-[-4%] ' href={tweetLink as unknown as string}> @{twitterUsername} </a><span/></h6>
        </div>

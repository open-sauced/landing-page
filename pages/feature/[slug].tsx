...
const index: FC<FeaturePageProps> = ({
  data: { seoData, featurePageData, homePageData },
}) => {
  return (
    <>
      <Head>
      ...
      <div className="max-w-6xl mx-auto px-8 ">
        <BackgroundDrip>
          <Navigation
            navigationItems={
              (homePageData.about
                .navigationURLs as unknown as SanityNavigation[]) || []
            }
          />
          ...
          <div className=" max-w-[912px]  mx-auto ">
            <div className="mt-[100px] mb-[50px] mx-auto border-white border-[8px] shadow-2xl ">
              <ReactPlayer
                ...
                url={featurePageData.previewVideoUrl as unknown as string}
              />
            </div>
            ...
            <div className="flex gap-2">
              <div className="w-[30px] h-[30px] p-[2px] rounded-full items-center bg-gradient-to-r  from-darkOrange to-lightOrange">
                <Image
                  width={30}
                  height={30}
                  src={featurePageData.previewImage as unknown as string}
                />
              </div>

              <h1 className="text-gray300 text-[18px] font-bold">
                {featurePageData.title}
              </h1>
            </div>

            <div className=" my-[5px] py-[10px] pr-[10px] bg-white bg-opacity-[80%] rounded-r-md ">
              <p className="text-[16px] font-semibold text-gray150 mx-auto">
                {featurePageData.description}
              </p>
            </div>

            <Link href={homePageData.about.CTAButtonURL as unknown as string}>
              <a className="font-bold text-[14px] text-gray300">
